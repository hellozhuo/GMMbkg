 ...
 * Output: -
 */
void CVSlic::init_data(IplImage *image) {
 ...
 */
double CVSlic::compute_dist(int ci, CvPoint pixel, CvScalar colour) {
 ...
 */
CvPoint CVSlic::find_local_minimum(IplImage *image, CvPoint center) {
 ...
 * Output: -
 */
void CVSlic::generate_superpixels(IplImage *image, int step, int nc) {
    this->step = step;
    this->nc = nc;
    this->ns = step;
 ...
 * Output: -
 */
void CVSlic::create_connectivity(IplImage *image) {
 ...
 * Output: -
 */
void CVSlic::display_center_grid(IplImage *image, CvScalar colour) {
 ...
 * Output: -
 */
void CVSlic::display_contours(IplImage *image, CvScalar colour) {
 ...
 * Output: -
 */
void CVSlic::colour_with_cluster_means(IplImage *image) {
